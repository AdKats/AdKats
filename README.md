...
<p>
    ...
    <td>[playername or partial] [reason]</td>
    <td>Admin</td>
    ...
    <td>[minutes] [playername or partial] [reason]</td>
    <td>Admin</td>
    ...
    <td>[playername or partial] [message]</td>
    <td>Admin</td>
