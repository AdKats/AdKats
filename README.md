...
<ul>
    <li>
        ...
        Standard commands for player killing, kicking, punishing, banning, unbanning, moving, etc...Over 40 available
        in-game commands.
...
<ol>
    ...
    <li>
        ...
        <a href="http://sourceforge.net/projects/adkats/files/AdKats_v4.2.1.0.zip/download" target="_blank">Version
            4.2.1.0</a>
    </li>
    <li>
