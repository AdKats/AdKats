...
<p>
    Admin Toolset with a plethora of features, over 50 available in-game commands, and extensive ability for customization.
    AdKats focuses on making in-game admins more efficient and accurate at their jobs, with flexibility for almost any setup.
    Includes a cross-server ban enforcer with advanced enforcement features, metabans support, and the AdKats WebAdmin for out-of-game control has been released.
...
<ul>
    ...
    <li>
        ...
        System based on issued commands agains players, and from admins. Documentation below.
    </li>
    <li>
