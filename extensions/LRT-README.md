...
<ol>
    ...
    <li>
        ...
        AdKatsLRT is $25 for up to 5 servers running it, one-time fee, with free updates for the duration of the project. Payments accepted through <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=danielgradinjan%40gmail%2ecom&lc=US&item_name=AdKatsLRT%20%2d%20On%2dSpawn%20Loadout%20Enforcer%20for%20Procon%20Frostbite%20%2d%205%20Server%20Purchase&amount=25%2e00&currency_code=USD&no_note=0&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHostedGuest" target="_blank">PayPal (Click here for purchase)</a>. After payment, <a href="https://forum.myrcon.com/private.php?do=newpm&u=15312" target="_blank">private message ColColonCleaner</a> on the MyRCON forums about getting the plugin. Include links to the servers you will be running the loadout enforcer on, and your username on this site (Github.com) to access the plugin and any available updates.
    </li>
    <li>
